...
export PATH="$HOME/.sm/bin:$HOME/.sm/pkg/active/bin:/Users/joe/.cabal/bin:./node_modules/.bin:/usr/local/bin:$PATH:$HOME/bin"
export PAGER="less"
...
export PATH=".bundle/bin:$PATH" # Make sure bundler binstubs take precendence over rbenv shims
